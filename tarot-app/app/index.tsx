...
export default function WelcomeScreen() {
  ...
  const mockNatalData = {
    ...
    planets: [
      { name: "sun", symbol: "☉", sign: "taurus", degree: 3, minute: 14, house: 3, retrograde: false },
      { name: "moon", symbol: "☽", sign: "virgo", degree: 3, minute: 36, house: 8, retrograde: false },
      { name: "mercury", symbol: "☿", sign: "aries", degree: 18, minute: 48, house: 3, retrograde: true },
      { name: "venus", symbol: "♀", sign: "gemini", degree: 12, minute: 44, house: 5, retrograde: false },
      { name: "mars", symbol: "♂", sign: "cancer", degree: 11, minute: 21, house: 7, retrograde: false },
      { name: "jupiter", symbol: "♃", sign: "leo", degree: 4, minute: 27, house: 7, retrograde: false },
      { name: "saturn", symbol: "♄", sign: "aquarius", degree: 6, minute: 24, house: 1, retrograde: false },
      { name: "uranus", symbol: "♅", sign: "capricorn", degree: 13, minute: 48, house: 1, retrograde: true },
      { name: "neptune", symbol: "♆", sign: "capricorn", degree: 16, minute: 45, house: 1, retrograde: true },
      { name: "pluto", symbol: "♇", sign: "scorpio", degree: 19, minute: 26, house: 10, retrograde: true },
      { name: "north_node", symbol: "☊", sign: "capricorn", degree: 23, minute: 9, house: 1, retrograde: true },
      { name: "south_node", symbol: "☋", sign: "cancer", degree: 23, minute: 9, house: 7, retrograde: true },
      { name: "black_moon", symbol: "⚸", sign: "sagittarius", degree: 29, minute: 46, house: 12, retrograde: false },
      { name: "asc", symbol: "ASC", sign: "capricorn", degree: 11, minute: 17, house: null, retrograde: false },
      { name: "mc", symbol: "MC", sign: "scorpio", degree: 5, minute: 20, house: null, retrograde: false },
    ],
  };
